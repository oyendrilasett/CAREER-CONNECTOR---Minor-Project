...
//	public void DashEmp(UserEmpBean ueBean) {
//		Connection con=ConnectionProvider.createC();
//		try {
//			PreparedStatement pstm=con.prepareStatement("update employer set desig=?,comp_ln=?,logo=?,comp_web=?,domains=?,comp_about=? where e_email=?");
//			pstm.setString(1, ueBean.getDesig());
//			pstm.setString(2, ueBean.getComp_ln());
//			pstm.setString(3, ueBean.getLogo());
//			pstm.setString(4, ueBean.getComp_web());
//			pstm.setString(5, ueBean.getDomains());
//			pstm.setString(6, ueBean.getComp_about());
