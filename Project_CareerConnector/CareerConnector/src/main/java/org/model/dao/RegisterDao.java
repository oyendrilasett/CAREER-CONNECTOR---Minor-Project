...
//	public void DashJs(UserBean uBean) {
//		Connection con=ConnectionProvider.createC();
//		try {
//			PreparedStatement pstm=con.prepareStatement("update employer set resume_name=?,profile=?,website=?,ln_id=?,github=?,address=?,bio=?,qualification=?,skills=?,exp=?,projects=?,achieve=? where e_email=?");
//			pstm.setString(1, uBean.getResume());
//			pstm.setString(2, uBean.getProfile());
//			pstm.setString(3, uBean.getWebsite());
//			pstm.setString(4, uBean.getLn_id());
//			pstm.setString(5, uBean.getGithub());
//			pstm.setString(6, uBean.getAddress());
//			pstm.setString(1, uBean.getBio());
//			pstm.setString(2, uBean.getQualification());
//			pstm.setString(3, uBean.getSkills());
//			pstm.setString(4, uBean.getExp());
//			pstm.setString(5, uBean.getProjects());
//			pstm.setString(6, uBean.getAchieve());
