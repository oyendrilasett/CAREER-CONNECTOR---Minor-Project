      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            ...
            <a href="JOBS_JS1.jsp" class="btn btn:hover btn btn-warning btn-block btn-lg" style="background-color: rgb(36 106 175);width:60%;color:white;margin-left: -374px; border:1px solid rgb(36 106 175);height:44px;">Get Started</a>
          </div>        
                </form>
          </div>
        </div>
