            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        <form id="jobForm" action="ContactEMP" method="post" class="" onsubmit="return checkLogin()">

                            <div class="row form-group">

                                <div class="col-md-12">
                                    <label class="text-black" for="email">Employer Email</label>
                    ...
                    <div class="col-lg-5 ml-auto">
                        <div class="p-4 mb-3 bg-white">
                            <p class="mb-0 font-weight-bold" style="color: rgb(12, 75, 137)">Address</p>
                            <p class="mb-4">Kolkata,India</p>

                            <p class="mb-0 font-weight-bold" style="color: rgb(12, 75, 137)">Phone</p>
                            <p class="mb-4">+91 9876543210</p>

                            <p class="mb-0 font-weight-bold" style="color: rgb(12, 75, 137)">Email Address</p>
                            <p class="mb-0">careerconnector6@gmail.com</p>
